        	...
        	<li>
                ...
                <div class="pd-ctn">
                    <h2 class="pd-tit">
                    	...
                    	<span>	
                    		<img class="pro_new_icon" alt="Sản phầm mới" src="<?php echo get_stylesheet_directory_uri(); ?>/images/icon_pro_new.gif">
                    	</span>
                    	<?php } ?>

                    	<?php if(get_post_meta($post->ID, "wpcf-san-pham-hot")[0] == 1) { ?>
                    	<span>	
                    		<img class="pro_new_icon" alt="Sản phầm bán chạy" src="<?php echo get_stylesheet_directory_uri(); ?>/images/icon_pro_hot.gif">
                    	</span>
                    	<?php } ?>
